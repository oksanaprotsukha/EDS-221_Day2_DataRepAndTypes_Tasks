...
Create a scatterplot of length1 by weight for all trout in the dataset Customize so that the point color depends on reach Customize your color scheme (e.g. scale_color_manual()) Facet your plot by creek reach (facet_wrap(\~...)) Update grap?h axis labels and title Export your graph as cutthroat_size.png to the figs folder
